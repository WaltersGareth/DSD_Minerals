...
origLocation = "C:\DSD_Minerals\DATA\Photos\" & Application.UserProperties("FolderName") & "\"
newLocation = "C:\DSD_Minerals\Attachments\" & Application.UserProperties("FolderName") & "\"
httpLocation = "http://dsd-mer-reg-app.s3.amazonaws.com/" & Application.UserProperties("FolderName") & "/"
